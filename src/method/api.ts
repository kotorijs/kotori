...
class Api {
    private send;
    public constructor (send: Function) {
        this.send = send;
    }
     ...
     * @return {*}
     */
    public get_online_clients = (no_cache: boolean = false) => {
     ...
     * @return {*}
     */
    public send_private_msg = (message: string, user_id: number, auto_escape: boolean = false) => {
     ...
     * @return {*}
     */
    public send_group_msg = (message: string, group_id: number, auto_escape: boolean = false) => {
     ...
     * @return {*}
     */
    public send_msg = (message_type: 'private' | 'group', message: string, user_id?: number, group_id?: number, auto_escape: boolean = false) => {
        this.send('send_msg',
     ...
     * @return {*}
     */
    public mark_msg_as_read = (message_id: number) => {
     ...
     * @return {*}
     */
    public get_forward_msg = (message_id: string) => {
     ...
     * @return {*}
     */
    public send_group_forward_msg = (messages: msg_forward | msg_node[], group_id: number) => {
     ...
     * @return {*}
     */
    public send_private_forward_msg = (messages: msg_forward | msg_node[], user_id: number) => {
     ...
     * @return {*}
     */
    public get_group_msg_history = (message_seq: number, group_id: number) => {
     ...
     * @return {*}
     */
    public set_friend_add_request = (file: string, approve: boolean = true, remark: string) => {
     ...
     * @return {*}
     */
    public set_group_add_request = (file: string, type: 'add' | ' invite', approve: boolean = true, reason?: string) => {
     ...
     * @return {*}
     */
    public get_group_member_info = (group_id: number, user_id: number, no_cache: boolean = false) => {
     ...
     * @return {*}
     */
    public get_group_honor_info = (group_id: number, type: 'talkative' | 'performer' | 'legend' | 'strong_newbie' | 'emotion' | 'all' ) => {
     ...
     * @return {*}
     */
    public get_group_system_msg = (invited_requests: InvitedRequest[], join_requests: JoinRequest[]) => {
     ...
     * @return {*}
     */
    public set_group_portrait = (group_id: number, file: string, cache: number) => {
     ...
     * @return {*}
     */
    public set_group_ban = (group_id: number, user_id: number, duration: number = 30 * 60) => {
     ...
     * @return {*}
     */
    public set_group_anonymous_ban = (group_id: number, flag: string, duration: number = 30 * 60) => {
     ...
     * @return {*}
     */
    public set_group_kick = (group_id: number, user_id: number, reject_add_request: boolean = false) => {
     ...
     * @return {*}
     */
    public upload_group_file = (group_id: number, file: string, name: string, folder: string) => {
     ...
     * @return {*}
     */
    public delete_group_file = (group_id: number, file_id: string, busid: number) => {
     ...
     * @return {*}
     */
    public create_group_file_folder = (group_id: number, name: string, parent_id: '/' ) => {
     ...
     * @return {*}
     */
    public delete_group_folder = (group_id: number, folder_id: string) => {
     ...
     * @return {*}
     */
    public get_group_file_system_info = (group_id: number) => {
     ...
     * @return {*}
     */
    public get_group_root_files = (group_id: number) => {
     ...
     * @return {*}
     */
    public get_group_files_by_folder = (group_id: number, folder_id: string) => {
     ...
     * @return {*}
     */
    public get_group_file_url = (group_id: number, file_id: string, busid: number) => {
     ...
     * @return {*}
     */
    public upload_private_file = (group_id: number, file: string, name: string) => {
     ...
     * @return {*}
     */
    public reload_event_filter = (file: string) => {
     ...
     * @return {*}
     */
    public download_file = (url: string, thread_count: number, headers: string | obj[]) => {
     ...
     * @return {*}
     */
    public __get_word_slices = (content: string) => {
     ...
     * @return {*}
     */
    public __handle_quick_operation = (context: obj, operation: obj) => {
