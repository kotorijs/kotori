  ...
  [157],
  {
    ...
    6967: function (e, t, r) {
      ...
      var o = r(3741)["default"],
        ...
        u = (e) => l(n({}, "__esModule", { value: !0 }), e),
        g = {};
      c(g, { TerminalAdapter: () => O, colors: () => y, default: () => w }),
        (e.exports = u(g));
      var h = r(1527);
      const b = (
          e,
    ...
    3158: function (e, t, r) {
      ...
      class O {
        ...
        dye(e, t) {
          return t in this.c
            ? this.c[t](e)
            : t in this.customRules
            ? this.customRules[t](e)
            : this.clear(e);
        }
        clear(e) {
          return (
            this.clear.toString(), e.replace(/<clear>(.*?)<\/clear>/g, "$1")
          );
        }
      }
      ((e) => {
        ...
        e.createColor = t;
        const r = t({
          adapter: globalThis.document
            ? new m.default()
            : new y.TerminalAdapter(),
        });
        (e.parse = r.parse.bind(r)),
          (e.batch = r.batch.bind(r)),
          (e.dye = r.dye.bind(r)),
          (e.clear = r.clear.bind(r));
      })(O || (O = {}));
      var w = O;
    },
    1527: function (e) {
    ...
    4865: function (e, t, r) {
      ...
      function p(e, t) {
        ...
        for (const n of Object.keys(r))
          "string" !== typeof r[n] && (r[n] = String(r[n])),
            (o = o.replaceAll(`%${n}%`, r[n]));
        return o;
      }
      function d(e, t) {
        let r = e;
        ...
        constructor(e) {
          o(this, "instance", void 0),
            ...
            o(
              ...
              async (e, t, r, o = "get") =>
                (
                  await this.instance[o](
                    e,
                    Object.assign(this.config, r || {}, { params: t })
                  )
                ).data
            ),
            ...
            o(
              ...
              "post",
              async (e, t, r) =>
                (await d.default.post(e, t, Object.assign(this.config, r))).data
            ),
            o(
              this,
              "patch",
              async (e, t, r) =>
                (await d.default.patch(e, t, Object.assign(this.config, r)))
                  .data
            ),
            o(
              this,
              "put",
              async (e, t, r) =>
                (await d.default.put(e, t, Object.assign(this.config, r))).data
            ),
            ...
            (this.request = this.instance.interceptors.request.use.bind(
              this.instance.interceptors.request
            )),
            (this.response = this.instance.interceptors.response.use.bind(
              ...
              t(
                ...
                [
                  t(
                    ...
                    [
                      t("pps-button", { attrs: { theme: "confirm" } }, [
                        e._v("发送"),
                      ]),
                      t(
                        "pps-button",
                        { attrs: { theme: "primary", type: "reset" } },
                        [e._v("清屏")]
                      ),
                    ],
                    1
            ...
            sendMsg() {
              ...
              console.log(this.$ws.instance),
                0 === this.$ws.instance.readyState
                  ...
                  : 3 === this.$ws.instance.readyState &&
                    (this.$message.error("重新连接中..."), this.$ws.init()),
                this.sendFn(e),
                (this.inputData = "");
            },
            pushMsg(e) {
              ...
              const a = `[34m${r} [0m[1;33m[${
                this.loggerLevelMap[s]
              }] [0m(${o}): [0m ${this.color.parse(n)}`;
              this.$nextTick(() => {
